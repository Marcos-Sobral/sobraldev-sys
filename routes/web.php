...
Route::middleware('Admin')->prefix('/admin')->group(function(){
    ...
    Route::prefix('/tecnologia')->group(function(){
        ...
        Route::get('/deletar/{id}',[techController::class, 'destroy'])->name('admin.tech.destroy');
    });
    ...
    Route::prefix('/cientifico')->group(function(){
        Route::get('/',[projetoCientificoController::class, 'index'])->name('admin.cientifico.index');
        Route::get('/criar',[projetoCientificoController::class, 'create'])->name('admin.cientifico.create');
        Route::post('/criar',[projetoCientificoController::class, 'store'])->name('admin.cientifico.store');
        Route::get('/editar/{id}',[projetoCientificoController::class, 'edit'])->name('admin.cientifico.edit');
        Route::put('/editar/{id}',[projetoCientificoController::class, 'update'])->name('admin.cientifico.update');
        Route::get('/deletar/{id}',[projetoCientificoController::class, 'destroy'])->name('admin.cientifico.destroy');
    });
