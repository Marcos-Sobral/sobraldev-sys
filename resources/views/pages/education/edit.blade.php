                    ...
                    <form action="{{ route('admin.education.update', $education->education_id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-4">
                                ...
                                <x-text-input id="education_modality" class="block mt-1 w-full pl-4" type="text" name="education_modality" value="{{ old('education_modality', $education->education_modality) }}" required />
