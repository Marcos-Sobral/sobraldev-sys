    ...
    <span class="navbar-toggler-icon"></span>
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul id="nav_item" class="navbar-nav ms-auto">
              <li class="nav-item">
                <a class="nav-link " href="#Meus_projetos">Ultimas atualizações</a>
              </li>
              ...
              <li class="nav-item"><a href="https://github.com/Marcos-Sobral" class=" nav-link fs-6" target="_blank">GitHub <i class="fab  fa-github"></i></a></li>

              <li class="nav-item"><a href="https://www.linkedin.com/in/marcossobral-ti" target="_blank" class=" nav-link fs-6">linkedin <i class="fab fa-linkedin"></i></a></li>
            </ul>
          </div>
        </div>
      </nav>
